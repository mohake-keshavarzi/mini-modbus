...
public class WordFunctions {
    ...
    public static byte getLSByte(short inWord) {
        return (byte) (inWord & 0x00FF);
    }

    public static byte getMSByte(short inWord) {
        return (byte) ((inWord & 0xFF00) >> 8);
    }

    public static short MSBLSBJoin(byte MSB, byte LSB) {
    ...
    public static class CRC16 {
        ...
        public static short calculate(byte[] message, int start, int length) {
            int crc = 0xffff;
